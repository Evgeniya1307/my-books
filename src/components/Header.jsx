...
import { selectCart } from "../redux/slices/cartSlice"; //селектор в редаксе

function Header() {
  const { items, totalPrice } = useSelector(selectCart); //передала название фу-ию которую соз-ла в cartslice
  const location = useLocation(); //возвращает текущий location объект/при изменении текущего местоположения
